...
export function CategoryModal({ newdata, id }) {
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                            <h3 className="text-3xl font-bold text-red-900 dark:text-white">
                                {modalState === 1 ? "NUEVA CATEGORIA" : (modalState == 2 ? "MODIFICAR CATEGORIA" : 'CLOSE')}
                            </h3>
                        ...
                        <CategoryForm setCategories={newdata} idCategoria={id} />
                    </div>
                </div>
            </div>
        </>
