...
export function ModelModal({ modalState,brands,newdata, id }) {
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                            <h3 className="text-3xl font-bold text-red-900 dark:text-white">
                                {modalState === 1 ? "NUEVO MODELO" : (modalState == 2 ? "MODIFICAR MODELO" : 'CLOSE')}                            </h3>
                        ...
                        <ModelForm Marcas={brands} setModel={newdata} idModelo={id} />
                    </div>
                </div>
            </div>
        </>
