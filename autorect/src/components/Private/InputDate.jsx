export function InputDate({text}){
    return(
        <div className="relative z-0 w-1/2">
            <input type="date" id="floating_standard" className="block py-2.5 px-0 w-4/5 text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-gray-500 focus:outline-none focus:ring-0 peer" placeholder=" " >
